...
$AllowPublicEdit = false; //Leave false to disable public editing.
$pageFolder = "code/workspace/squwiki/"; //Folder where SquWiki is stored. (If this is stored in the root folder of your web server use: "/", otherwise follow: "foldername/" and yes the last slash is important.)
